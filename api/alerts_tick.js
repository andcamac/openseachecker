...
import { enabled, redis, pipeline, tgSend, K, esc, SECRET, selfBase } from "../lib/alerts.js";
...
export default async function handler(req, res) {
  ...
  const [os, me, oc] = await Promise.all([get("/api/drops"), get("/api/me?route=launchpad&days=1"), get("/api/sol_mints")]);
